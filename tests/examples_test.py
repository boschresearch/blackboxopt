...
from blackboxopt.examples import (
    multi_objective_multi_param,
    visualize_objective_over_iteration,
)


@pytest.mark.parametrize(
    "example_module", [multi_objective_multi_param, visualize_objective_over_iteration]
)
...
def test_full_loop_examples(tmp_path, monkeypatch, example_module):
    ...
    if hasattr(example_module, "run_optimization_loop"):
